...
echo "1. Kde 2. Gnome 3. DWM-core 4. DWM-most"
`echo $'\n '`
read -p "Enter selection:  `echo $'\n> '`" choice
...
then
	installation="DWM-CORE"
elif [ $choice -eq 4 ]
then
	installation="DWM-MOST"
fi

`echo $'\n '`

read -p "Would you like to install yay AUR helper? (y/n) `echo $'\n> '`" yay
