...
static const char col_dgray[]       = "#646464";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_dgray,  col_dgray  },
};

/* tagging */
static const char *tags[] = { "", "", "", "", "", "", "7", "8", "9" }; 
/* https://fontawesome.com/v4.7.0/cheatsheet/ */
/*https://bbs.archlinux.org/viewtopic.php?id=156000*/
/*https://www.youtube.com/watch?v=w8NE_1ylnDw*/

static Rule rules[] = {
		/* class                instance     title        tags mask     isfloating   monitor */
		{ "deadbeef",           NULL,        NULL,        1 << 7,       0,            0 },
		{ "ProtonMail Bridge",  NULL,        NULL,        1 << 3,       0,           -1 },
		{ "Bubblemail",         NULL,        NULL,        1 << 3,       0,           -1 },
		{ "Element",            NULL,        NULL,        1 << 2,       0,           -1 },
		{ "st-256color",        NULL,        "mutt",      1 << 3,       0,           -1 },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_dgray, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *browser[]  = { "librewolf", NULL };
static const char *mail[]     = { "st -e 'mutt'", NULL };
static const char *pass[]     = { "keepassxc", NULL };
static const char *elem[]     = { "element-desktop", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_e,      spawn,          {.v = elem } },
	{ MODKEY|ShiftMask,		XK_x,	   spawn,	   {.v = file } },
